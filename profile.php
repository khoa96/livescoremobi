      ...
      <div class="account-header">
        <div class="user-info-wrapper">
          ...
          <div class="info-detail">
            ...
            <p class="line">
              <a href="#" target="" class="text-link-change-password">Change password</a>
            </p>
            <p class="line expiration-date-wrapper">
              <span class="expiration-date">Expiration Date: <strong>2025-12-20 02:02:19</strong></span>
              <span class="renew-plan">Renew plan: 2023-12-20. <a href="#" class="txt-cancel-renew-link">Cancel renew.</a></span>
            </p>
          </div>
        </div>
