      ...
      <div class="center-main-layout scores-page-content-wrapper">
        ...
        <div id="scores-tabs">
          ...
          <div id="tabs-1" class="main-tab-content">
            <div class="all-tab-content-wrapper">
              <div class="group-filter-match-by-time">
                <h2 class="time-label">Today</h2>
                <div class="filter-match-list">
                  <a class="filter-match-list__item" href="#">
                    <div class="left-content">
                      <div class="top-content">
                        ...
                        <div class="top-right-content">
                          <span class="time-label">29'</span>
                        </div>
                      </div>
                      <div class="bottom-content">
                        <p class="text-overflow league-name">Premier League Premier League.</p>
                      </div>
                    </div>
                      ...
                      <div class="list-club">
                        <div class="club-item first-club">
                          <div class="club-name-wrapper">
                            <span class="club-name text-overflow">Liverpool net-busting live coverage of the Premier
                              League.</span>
                          </div>
                          <img src="./images/club-1.png" class="club-image" alt="">
                        </div>
                        <div class="match-result">
                          <span class="score-text">5 : 0</span>
                        </div>
                        <div class="club-item second-club">
                          <img src="./images/club-2.png" class="club-image" alt="">
                          <div class="club-name-wrapper">
                            <span class="club-name text-overflow">Chelsea net-busting live coverage of the Premier
                              League.</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <a class="filter-match-list__item" href="#">
                    <div class="left-content">
                      ...
                      <div class="bottom-content">
                        <p class="text-overflow league-name">Premier </p>
                      </div>
                    </div>
                    <div class="right-content">
                      <div class="list-club">
                        <div class="club-item first-club">
                          <div class="club-name-wrapper">
                            <span class="club-name text-overflow">Liverpool</span>
                          </div>
                          <img src="./images/club-1.png" class="club-image" alt="">
                        </div>
                        <div class="match-result">
                        ...
                        <div class="club-item second-club">
                          <img src="./images/club-2.png" class="club-image" alt="">
                          <div class="club-name-wrapper">
                            <span class="club-name text-overflow">Chelsea net-busting</span>
                          </div>
                        </div>
                      </div>
                      <button class="btn-watch">watch</button>
                  ...
                  <a class="filter-match-list__item" href="#">
                    <div class="left-content">
                      ...
                      <div class="bottom-content">
                        <p class="text-overflow league-name">BBL</p>
                      </div>
                    </div>
                    <div class="right-content">
                      <div class="list-club">
                        <p class="text-overflow club-name">Thunder vs Thunder vs Heat Thunder vs HeatThunder vs
                          HeatThunder vs HeatThunder vs HeatThunder vs Heat</p>
                      </div>
                      <button class="btn-watch">watch</button>
                    </div>
                  </a>
                  <a class="filter-match-list__item" href="#">
                    <div class="left-content">
                      <div class="top-content">
                        <span class="hour-label">02:00</span>
                        <div class="top-right-content">
                          <span class="sign">NS</span>
                        </div>
                      </div>
                      <div class="bottom-content">
                        <p class="text-overflow league-name">BBL</p>
                  ...
                  <a class="filter-match-list__item" href="#">
                    <div class="left-content">
                      ...
                      <div class="bottom-content">
                        <p class="text-overflow league-name">Liverpool League</p>
                      </div>
                    </div>
                    <div class="right-content">
                      <div class="list-club">
                ...
                <div class="group-filter-match-by-time">
                <h2 class="time-label">Wednesday, 13/12</h2>
                <div class="filter-match-list">
                  <a class="filter-match-list__item" href="#">
                    <div class="left-content">
                      <div class="top-content">
                    ...
                    <div class="list-result-league">
                      <div class="block-club-common">
                        ...
                        <div class="list-odds-value">
                          <div class="odds-item">
                            <span class="icon">
                              <svg id="arrow-red" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.18294 13.1667L8.18294 3.16666" stroke="#F91E4E" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M12.1992 9.13345L8.18317 13.1668L4.1665 9.13345" stroke="#F91E4E"
                          ...
                          <div class="odds-item">
                            <span class="icon">
                              <svg id="arrow-green" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.81706 2.83334L7.81706 12.8333" stroke="#009A5F" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M3.80083 6.86655L7.81683 2.83321L11.8335 6.86655" stroke="#009A5F"
                                  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
